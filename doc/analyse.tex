...
\noindent As explained in \cite{Trefethen:1982}, as the grid is discrete, the dispersion relations like Eq.~(\ref{eq:tan_dispersion_relation_LW}) are multipled-valued and $2\pi$-periodic in $\xi h$ and $\omega k$. In practice and when needed, the relevant branch is chosen by continuity with the low-frequency limit $\omega k \sim c\,\xi h$. 
